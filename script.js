...
//Sort
// const idFilter = data.sort((a,b) => b.id - a.id)
// const sortByName = data.sort((a,b) => (a.name > b.name) ? 1 : ((b.name > a.name) ? -1 : 0))
// const sortByEmail = data.sort((a,b) => (a.email > b.email) ? 1 : ((b.email > a.email) ? -1 : 0))
// console.table(sortByName)


//Filter
// let keyword = 'Cl'
// const filterOfKeyWord = data.filter((value) => value.name.toLocaleLowerCase().includes(keyword.toLocaleLowerCase()))

// console.log(filterOfKeyWord);
